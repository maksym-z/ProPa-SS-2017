...
enum fahrzeug {LINKS, RECHTS, GERADEAUS};
...
enum spur {
  ...
  D1 = 5,
  D2 = 6,
  SPUR_ANZAHL = 7 // keine Spur, sondern ein Meta-Wert
};
...
class kreuzung {
  ...
  const std::vector<traffic_light_state> light_states = {
    {{true, false, true, false, false, false, false}, 25},
    {{false, false, false, false, false, false, false}, 5},
    {{false, true, false, true, false, false, false}, 15},
    {{false, false, false, false, false, false, false}, 5},
    {{false, false, false, false, true, true, true}, 20},
    {{false, false, false, false, false, false, false}, 5}
  };
  ...
  const std::array<spur, SPUR_ANZAHL> gegenverkehr{
    {SPUR_ANZAHL, SPUR_ANZAHL, SPUR_ANZAHL, SPUR_ANZAHL, D1, SPUR_ANZAHL, C} };
